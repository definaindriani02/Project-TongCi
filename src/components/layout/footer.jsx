    ...
    <footer style={{ backgroundColor: "#1b2e1e", color: "#b3c7b6", padding: "60px 20px 30px 20px" }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr", gap: "40px", marginBottom: "40px" }}>
          <div>
            <h3 style={{ color: "#fff", fontSize: "22px", fontWeight: "700", margin: "0 0 15px 0" }}>
          ...
          <div>
            ...
            <ul style={styles.list}>
              ...
              <li>
                <a
                  href="/edukasi"
                  onClick={(e) => handleProtectedNavigation(e, "/edukasi")}
                  style={styles.link}
                >
                  Edukasi
                </a>
              ...
              <li>
                <a
                  href="/scan"
                  onClick={(e) => handleProtectedNavigation(e, "/scan")}
                  style={styles.link}
                >
                  Klasifikasi AI
                </a>
          ...
          <div>
            ...
            <ul style={styles.list}>
              <li><a href="#tentang" style={styles.link}>Tentang Kami</a></li>
...
const styles = {
  ...
  link: { color: "#b3c7b6", textDecoration: "none", fontSize: "14px", cursor: "pointer" }
};